          ...
          {items.map((project) => (
            ...
            >
              ...
              <div className="sm:col-span-3 bg-section-alt flex flex-col justify-center gap-4 p-8 md:p-10">
                ...
                <Link
                  to={project.href}
                  className="inline-flex items-center gap-1 px-5 py-2 bg-navy text-white text-sm font-semibold rounded-md hover:bg-primary-blue transition-colors w-fit font-sans"
                >
                  Read More →
                </Link>
              </div>
