      ...
      <div className="container">
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {items.map((item) => (
            <div
              key={item.id}
              className="bg-card rounded-2xl p-6 flex flex-col gap-3 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300"
            >
              <div className="w-10 h-10 rounded-full bg-sky-accent/20 flex items-center justify-center">
                {ICONS[item.icon]}
              </div>
              <h3 className="text-sm font-bold text-navy font-display">{item.title}</h3>
